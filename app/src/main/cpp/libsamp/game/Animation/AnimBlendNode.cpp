//
// Created by plaka on 06.05.2023.
//
...
bool CAnimBlendNode::NextKeyFrame() {
    return CHook::CallFunction<bool> (g_libGTASA + 0x0033A9C8 + 1, this);
}

// 0x4D0570
bool CAnimBlendNode::NextKeyFrameCompressed() {
    return CHook::CallFunction<bool>(g_libGTASA + 0x0033AFDC + 1, this);
}

// 0x4CFB90
bool CAnimBlendNode::NextKeyFrameNoCalc() {
    return CHook::CallFunction<bool>(g_libGTASA + 0x0033A810 + 1, this);
}
...
bool CAnimBlendNode::Update(CVector& trans, CQuaternion& rot, float weight) {
    return CHook::CallFunction<bool>(g_libGTASA + 0x0033AA80 + 1, this, trans, rot, weight);
}

// 0x4D08D0
bool CAnimBlendNode::UpdateCompressed(CVector& trans, CQuaternion& rot, float weight) {
    return CHook::CallFunction<bool>(g_libGTASA + 0x0033B0A8 + 1, this, trans, rot, weight);
}
