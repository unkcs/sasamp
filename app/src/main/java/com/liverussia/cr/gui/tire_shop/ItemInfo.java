...
public enum ItemInfo {
    ...
    SUSPENSION(2, -1, -1, R.drawable.tire_shop_suspension_button, R.drawable.tire_shop_suspension_button, ItemType.MAIN_MENU_ITEM, "Высота подвески"),
    PREFIXES(3, -1, -1, R.drawable.tire_shop_prefixes_button, R.drawable.tire_shop_prefixes_button, ItemType.MAIN_MENU_ITEM, "Проставки"),
    WHEEL_WIDTH(4, -1, -1, R.drawable.tire_shop_wheel_width_button, R.drawable.tire_shop_wheel_width_button, ItemType.MAIN_MENU_ITEM, "Ширина колес"),
    WHEEL_DIAMETER(5, -1, -1, R.drawable.tire_shop_wheel_diameter_button, R.drawable.tire_shop_wheel_diameter_button, ItemType.MAIN_MENU_ITEM, "Диаметр колес"),
    DISK_TYPE(6, -1, -1, R.drawable.tire_shop_disk_type_button, R.drawable.tire_shop_disk_type_button, ItemType.MAIN_MENU_ITEM, "Диски"),
