...
public class Config {
    public static final String FULLCACHE_ZIP_NAME = "cache.zip";
    public static final String CACHE_ZIP_URL = "https://files.liverussia.online/downloads/" + FULLCACHE_ZIP_NAME;
